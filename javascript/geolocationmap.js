class Geolocation {
    ...
    successCallback(position) {
        ...
        // result.innerText = "User's Cordinates: " + "Lat: " + position.coords.latitude + ", Long: " + position.coords.longitude // display the latitude and longitude
        ...
        //using a red marker map icon for user position
        // var myIcon = L.icon({
        //     iconUrl: 'images/iconmarkermap1.png',
        //     iconSize: [50, 40],
        //     iconAnchor: null,
        // });
    ...
    showPosition() {
        if (navigator.geolocation) { // if the browser supports geolocation
            ...
            // result.innerText = "Getting user position information..."
        } else {
